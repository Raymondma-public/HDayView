...
import com.linkedin.android.tachyon.HDayView;
...
public class SampleActivity extends AppCompatActivity {
    ...
    private void onEventsChange() {
        ...
        List<HDayView.EventTimeRange> eventTimeRanges = null;
        ...
        if (events != null) {
            ...
            for (final Event event : events) {
                ...
                eventTimeRanges.add(new HDayView.EventTimeRange(startMinute, endMinute));
            }
        }
    ...
    private void showScrollTargetDialog() {
        ...
        timeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimePickerDialog.OnTimeSetListener listener = new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        int start = dayView.getHourStart(hourOfDay);
                        int end = dayView.getHourEnd(hourOfDay);
                        int x = start + (end - start) * minute / 60;
        ...
        firstEventTopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                scrollView.smoothScrollTo(0, dayView.getFirstEventStart());
                dialog.dismiss();
            }
        });
        ...
        firstEventBottomButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                scrollView.smoothScrollTo(0, dayView.getFirstEventEnd());
                dialog.dismiss();
            }
        });
        ...
        lastEventTopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                scrollView.smoothScrollTo(0, dayView.getLastEventStart());
                dialog.dismiss();
            }
        });
        ...
        lastEventBottomButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                scrollView.smoothScrollTo(0, dayView.getLastEventEnd());
                dialog.dismiss();
