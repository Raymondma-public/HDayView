...
public class DirectionalRect {
     ...
     * @param parentHeight the width of the parent view of the rect, this will be used to figure out
     *                    how to translate
     ...
     */
    public void set(boolean isRtl, int parentHeight, int start, int top, int end, int bottom) {
        this.top = isRtl ? parentHeight - bottom : top;
        this.left = start;
        this.bottom = isRtl ? parentHeight - top : bottom;
        this.right = end;
    }
